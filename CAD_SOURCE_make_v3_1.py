...
# Rear seam rails, leaving central 190x190 opening clear
railw=10.0
...
# Front retainer frame, 4.5 mm thick. Screen opening gives exactly 2 mm overlap onto published chassis envelope.
...
for i,ov in enumerate((1.0,2.0,3.0)):
    x=-24+i*24
